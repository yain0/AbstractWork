...
new Lazy<IUnityContainer>(() =>
{
    ...
    return container;
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IMaterialService, MaterialServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IWorkerService, WorkerServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IRemontService, RemontServiceBD>(new HierarchicalLifetimeManager());
